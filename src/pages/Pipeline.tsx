            ...
            <SavedFiltersPopover
              ...
              onApply={(f) => {
                setFilters({
                  ...
                  manufacturerId: (f.manufacturerId as string) ?? "",
                  minValue: (f.minValue as string) ?? "",
                  maxValue: (f.maxValue as string) ?? "",
                });
                setShowFilters(true);
              }}
          ...
          <DragDropContext onDragEnd={handleDragEnd}>
            <div className="flex gap-2 overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0">
              {DEAL_STATUSES.map((status) => {
                ...
                return (
                  <div key={status.value} className="flex-shrink-0 w-64 lg:w-72">

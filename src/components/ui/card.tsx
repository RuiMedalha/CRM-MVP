...
/**
 * Card 17 redesign — border sutil + shadow tinted brand.
 * `interactive` adiciona hover lift + cursor pointer.
 */
...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { interactive?: boolean }>(
  ({ className, interactive = false, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl border border-border/70 bg-card text-card-foreground shadow-brand-sm",

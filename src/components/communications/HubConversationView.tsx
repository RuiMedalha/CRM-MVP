...
export function HubConversationView() {
  ...
  const {
    ...
    queryKey: ["contact-360", contactId],
    ...
    <div className="flex min-h-0 flex-1 overflow-hidden">
      ...
      {panelVisible && conversation && (
        <ComunicacoesCliente360Panel
          ...
          conversationPhone={
            // O número WA está em source ou visitorId (ex: "244523637019@s.whatsapp.net")
            conversation?.source ?? conversation?.visitorId ?? conversation?.customerName
          }

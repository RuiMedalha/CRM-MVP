...
const DEFAULT_CONTACT_FIELDS = new Set<string>([
  ...
  "whatsapp_marketing_permitido",
  "telefone_marketing_permitido",
  "consentimento_rgpd",
  "data_consentimento_rgpd",
  "origem_consentimento_rgpd",
  "versao_termos_rgpd",
  "idioma",
  "segmento_marketing",
  "newsletter_welcome_sent",
  ...
  "garantia_meses",
  "catalogo_url",
  "tabela_precos_fornecedor_url",
  "email_encomendas_fornecedor",
  "portal_b2b_url",
  "user_portal_b2b",
  "pass_portal_b2b",
  "avaliacao_qualidade",
